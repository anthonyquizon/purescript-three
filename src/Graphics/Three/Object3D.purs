...
createMesh :: forall a. M.Material a => G.Geometry -> a -> Effect Mesh
createMesh = ffi ["geometry", "material", ""] "new THREE.Mesh(geometry, material)"

createLine :: forall a. M.Material a => G.Geometry -> a -> LineType -> Effect Line
createLine g m t = create g m $ show t
    where
        create = ffi ["geometry", "material", "lineType", ""] "new THREE.Line(geometry, material)"

getPosition :: forall a. Object3D a => a -> Effect Vector3
...
getRotationEuler :: forall a. Object3D a => a -> Number -> Number -> Number -> Effect Euler
getRotationEuler = ffi ["object", ""] "object.rotation"

setRotationEuler :: forall a. Object3D a => a -> Number -> Number -> Number -> Effect Unit
setRotationEuler = fpi ["object", "x", "y", "z", ""] "object.rotation.set(x, y, z)" --TODO change to euler? Add order

rotateIncrement :: forall a. Object3D a => a -> Number -> Number -> Number -> Effect Unit
rotateIncrement = fpi ["object", "x", "y", "z", ""] 
    "object.rotation.x += x; object.rotation.y += y; object.rotation.z += z;"

getGeometry :: forall a. Renderable a => a -> Effect G.Geometry
getGeometry = ffi ["object", ""] "object.geometry"

getMaterial :: forall a b. Renderable a => M.Material b => a -> Effect b
